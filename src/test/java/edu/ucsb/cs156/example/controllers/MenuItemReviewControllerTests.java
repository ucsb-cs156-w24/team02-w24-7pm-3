...
public class MenuItemReviewControllerTests extends ControllerTestCase {
    ...
    public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
            ...
            MvcResult response = mockMvc.perform(
                            post("/api/menuitemreview/post?itemId=5&reviewerEmail=cgaucho@ucsb.edu&stars=5&dateReviewed=2022-01-03T00:00:00&comments=Loved it")
                                            .with(csrf()))
                            .andExpect(status().isOk()).andReturn();
    ...
    @WithMockUser(roles = { "ADMIN", "USER" })
    @Test
    public void admin_tries_to_delete_non_existant_menu_review_and_gets_right_error_message()
                    throws Exception {
            // arrange
